// jsprops.cpp — Unicode property span tables for jsre \p{...}.
// Generated by gen_props.mjs against Node/V8; regenerate rather than edit.
#include "jsprops.h"
...
const PropRange kLC[] = {
    ...
    {0x0295, 0x02AF}, {0x0370, 0x0373}, {0x0376, 0x0377}, {0x037B, 0x037D},
    {0x037F, 0x037F}, {0x0386, 0x0386}, {0x0388, 0x038A}, {0x038C, 0x038C},
    {0x038E, 0x03A1}, {0x03A3, 0x03F5}, {0x03F7, 0x0481}, {0x048A, 0x052F},
    {0x0531, 0x0556}, {0x0560, 0x0588}, {0x10A0, 0x10C5}, {0x10C7, 0x10C7},
    {0x10CD, 0x10CD}, {0x10D0, 0x10FA}, {0x10FD, 0x10FF}, {0x13A0, 0x13F5},
    ...
    {0x1FF2, 0x1FF4}, {0x1FF6, 0x1FFC}, {0x2102, 0x2102}, {0x2107, 0x2107},
    {0x210A, 0x2113}, {0x2115, 0x2115}, {0x2119, 0x211D}, {0x2124, 0x2124},
    {0x2126, 0x2126}, {0x2128, 0x2128}, {0x212A, 0x212D}, {0x212F, 0x2134},
    {0x2139, 0x2139}, {0x213C, 0x213F}, {0x2145, 0x2149}, {0x214E, 0x214E},
...
const PropRange kC[] = {
    ...
    {0x085F, 0x085F}, {0x086B, 0x086F}, {0x088F, 0x0896}, {0x08E2, 0x08E2},
    ...
    {0x1FDC, 0x1FDC}, {0x1FF0, 0x1FF1}, {0x1FF5, 0x1FF5}, {0x1FFF, 0x1FFF},
...
// Any: 1 ranges
const PropRange kAny[] = {
    {0x0000, 0x10FFFF},
};

// ASCII: 1 ranges
const PropRange kASCII[] = {
    {0x0000, 0x007F},
};

struct PropTable {
    const char* name;
    const PropRange* ranges;
    size_t count;
};

const PropTable kTables[] = {
    {"L", kL, 677},
    {"Letter", kL, 677},
    {"Lu", kLu, 651},
    {"Uppercase_Letter", kLu, 651},
    {"Ll", kLl, 662},
    {"Lowercase_Letter", kLl, 662},
    {"Lt", kLt, 10},
    {"Titlecase_Letter", kLt, 10},
    {"Lm", kLm, 75},
    {"Modifier_Letter", kLm, 75},
    {"Lo", kLo, 528},
    {"Other_Letter", kLo, 528},
    {"LC", kLC, 145},
    {"Cased_Letter", kLC, 145},
    {"N", kN, 144},
    {"Number", kN, 144},
    {"Nd", kNd, 71},
    {"Decimal_Number", kNd, 71},
    {"Nl", kNl, 12},
    {"Letter_Number", kNl, 12},
    {"No", kNo, 72},
    {"Other_Number", kNo, 72},
    {"M", kM, 321},
    {"Mark", kM, 321},
    {"Mn", kMn, 357},
    {"Nonspacing_Mark", kMn, 357},
    {"Mc", kMc, 190},
    {"Spacing_Mark", kMc, 190},
    {"Me", kMe, 5},
    {"Enclosing_Mark", kMe, 5},
    {"P", kP, 198},
    {"Punctuation", kP, 198},
    {"S", kS, 236},
    {"Symbol", kS, 236},
    ...
    {"Separator", kZ, 8},
    {"Zs", kZs, 7},
    {"Space_Separator", kZs, 7},
    {"C", kC, 736},
    {"Other", kC, 736},
    {"White_Space", kWhiteSpace, 10},
    {"Alphabetic", kAlphabetic, 757},
    {"Any", kAny, 1},
    {"ASCII", kASCII, 1},
};
const size_t kTableCount = sizeof(kTables) / sizeof(kTables[0]);

}  // namespace

bool propertyRangesFor(const std::string& name, std::vector<PropRange>& out) {
    for (size_t t = 0; t < kTableCount; t++) {
        if (name != kTables[t].name) continue;
        out.assign(kTables[t].ranges, kTables[t].ranges + kTables[t].count);
        return true;
    }
    return false;
}
